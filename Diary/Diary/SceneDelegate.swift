...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let firstViewController = UINavigationController(rootViewController: FolderViewController())
        let secondViewController = UINavigationController(rootViewController: StarViewController())
