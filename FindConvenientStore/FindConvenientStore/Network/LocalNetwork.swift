...
class LocalNetwork {
    ...
    func getLocaion(by mapPoint: MTMapPoint) -> Single<Result<LocationData,URLError>> {
        ...
        request.setValue("KakaoAK 71cc15f62fb4f33fa82cb4607b21c5ae", forHTTPHeaderField:"Authorization")
